...
aBubPubSub.prototype.subscribe = function(topic, callback, options, subscriberId) {
    ...
    subscriberId = this.__getSubscriberId(topic, subscriberId);
	}
...
aBubPubSub.prototype.__getSubscriberId = function (topic, subscriberId) {
  if (typeof this.publicationChannels[topic][subscriberId] !== 'undefined') {
